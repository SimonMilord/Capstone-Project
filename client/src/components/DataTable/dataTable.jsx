      ...
      <div className='data-left'>
        ...
        <div className='data__item'>
          <div className='data-tooltip-wrap'>
            ...
            <Tooltip title="Average # of shares that traded in the last 10 days" placement="top">
        ...
        <div className='data__item'>
          <div className='data-tooltip-wrap'>
            ...
            <Tooltip title="Trailing 12 months earnings per share" placement="top">
              <InfoOutlinedIcon style={{ fontSize: ttsize }}/>
            </Tooltip>
          </div>
          <div className='data__value'>{fin.metric && Number(fin.metric.epsInclExtraItemsTTM).toFixed(2)}</div>
        </div>
      </div>
      <div className='data-right'>
        <div className='data__item data__item--first'>
          <div className='data-tooltip-wrap'>
            ...
            <Tooltip title='Represents the market value of the company' placement="top">
              <InfoOutlinedIcon style={{ fontSize: ttsize }}/>
            </Tooltip>
          </div>
        ...
        <div className='data__item'>
          <div className='data-tooltip-wrap'>
            ...
            <Tooltip title="Valuation ratio that measures a company current share price relative to its earnings per share (EPS)" placement="top">
              <InfoOutlinedIcon style={{ fontSize: ttsize }}/>
            </Tooltip>
          </div>
